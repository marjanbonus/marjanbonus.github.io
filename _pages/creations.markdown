...
[![keyhole_cockpit_coaming](/assets/images/creations/keyhole_coaming_small.webp)]({{ site.baseurl }}{% link _pages/creations/keyhole-cockpit-coaming.markdown %}){:class="hover-img-effect"}[Keyhole Cockpit Coaming]({{ site.baseurl }}{% link _pages/creations/keyhole-cockpit-coaming.markdown %}){:class="title"}
